...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    ArrayList<ShoppingCart> cList;
    Context context;
    float gtotal;
    DatabaseReference dbRef;

    public CartAdapter(ArrayList<ShoppingCart> cList, Context context) {
        this.cList = cList;
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ShoppingCart cart = cList.get(position);
        ...
        dbRef.child("FashionStock").child(cart.getProd_id()).child(cart.getProd_size()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        holder.remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbRef.child("FashionCart").child(cart.getCust_id()).child("FashionItems").child(cart.getCart_id()).removeValue();

                if(holder.checkBox.isChecked()){
                    gtotal -=total;
                    ShoppingcartFragment.updateGrandTotal("Total: Rs. "+String.valueOf(gtotal));
                    ShoppingcartFragment.selectedItems.remove(cart);
                }
        ...
        holder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    gtotal +=total;
                    ShoppingcartFragment.selectedItems.add(cart);
                }
                else{
                    gtotal -=total;
                    ShoppingcartFragment.selectedItems.remove(cart);
    ...
    public static class CartViewHolder extends RecyclerView.ViewHolder {
        ...
        public CartViewHolder(@NonNull View itemView) {
            super(itemView);
            checkBox = itemView.findViewById(R.id.cart_items_check);
